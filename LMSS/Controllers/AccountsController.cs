...
namespace LMSS.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public AccountsController(LibraryManagementSystemContext context,IAccountRepo account)
        {
            _context = context;
            _account= account;
        }
        ...
        public IActionResult LoginDash(string username, string password)
        {
            if (username != null || password != null)
            {
               
                var user = _account.GetAccountByName(username);
                if (user == null)
                {
                ...
                else if (username.Equals(user.UserName) && password.Equals(user.Password))
                {
                    ...
                    return RedirectToAction("User_dash", "BooksUser");
